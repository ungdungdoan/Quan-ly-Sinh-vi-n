...
import SM_App.com.connectdatabase;
...
public class App_Model {
	...
	// Them Sinh Vien
	public boolean themSinhVien(String masv, String hoten, String diachi, String sdt, String ngaysinh, String gioitinh,
	...
	public String TimSV(String maSV) {
		...
		try {
			...
			if (rs.next()) {
				...
				sv.put("ngaysinh", rs.getString(3));
	...
	public String xuatDSL() {
		Connection con = connectdatabase.Connect();
		JSONObject  res;
		JSONArray loplst = new JSONArray();
		res = new JSONObject();
		try {
			String sql = "select maLop from LOP ";
			java.sql.Statement stm = con.createStatement();
